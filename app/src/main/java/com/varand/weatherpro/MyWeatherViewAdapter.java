...
public class MyWeatherViewAdapter extends RecyclerView.Adapter<MyWeatherViewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        //holder.myimg.setImageDrawable(R.drawable.ic_launcher_background);
        //Picasso.get().load("").into(holder.myimg);
    }
